...
public abstract class RecyclerViewDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            RecyclerViewDivider divider = getDivider(itemPosition);
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (divider == null) {
            divider = new RecyclerViewDividerBuilder().create();
        }
    ...
    public abstract RecyclerViewDivider getDivider(int itemPosition);
